    ...
    for(int i = 0 ; i < command.size() ; i++){
        if(command[i] == "NUM"){
            ...
            if(stk.size() < 1) return false;
                ...
                long long tmp1 = stk.back(); stk.pop_back();
                long long tmp2 = stk.back(); stk.pop_back();
                stk.push_back(tmp1);
                stk.push_back(tmp2);
            }
                ...
                tmp1 = stk.back(); stk.pop_back();
                tmp2 = stk.back(); stk.pop_back();
...
int main(){
    ...
    while(1){
        ...
        for(int i = 0 ; i < n ; i++){
            ...
            if(!program() || stk.size() != 1) cout << "ERROR\n";
            else cout << stk[0] << '\n';
